...
QUnit.test("test currency > 3 ", function(assert)
    {
        ...
        fixture+=("<input type='text' id='c1' name='c1' value='EUROS'/>");
        fixture+=("<input type='text' id='v2' name='v2' value='1'/>");
        fixture+=("<input type='text' id='c2' name='c2' value='CHFFF'/>");
        fixture+=("<input type='text' id='ops' name='ops' value='SUB'/>");
        fixture+=("</form>");
        ...
        var c=new calc();
        c.computeResult(document.getElementById('form0'));
        assert.equal(c.message,"Currency est supérieur à Trois");
    }
);
QUnit.test("test Exception couleur rouge", function(assert)
    {
        var fixture="";
        fixture+=("<div id='res'></div>");
        fixture+=("<form id='form0'>");
        ...
        assert.equal(c.message,"Money inférieur à Zéro  ");
    }
);
QUnit.test("test not Exception couleur noir ", function(assert)
    {
        var fixture="";
        fixture+=("<div id='res'></div>");
        fixture+=("<form id='form0'>");
        ...
        var color = document.getElementById('res').style.color;
        assert.equal(color,"rgb(0, 0, 0)");
